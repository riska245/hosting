...
<div class="text-center mb-10">
       ...
       class="inline-flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400 hover:underline mb-5">
        ...
        Kembali ke Pilihan Login
            ...
            <!-- Login Form (Simulation) -->
                <form action="/login-user-process" method="POST" autocomplete="off" class="space-y-6">         
                    @csrf
                        <!-- Username -->
                <div>
                ...
                <!-- Email Pengguna -->
                <div>
                    <label for="email" class="block text-sm font-medium text-black dark:text-slate-300 mb-2 transition-colors">
                        Email Pengguna
                    </label>

                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-slate-400 dark:text-slate-500"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                                    ...
                                    stroke-width="2"
                                    d="M16 12H8m8 0l-8 0m8 0l-2-2m2 2l-2 2M4 6h16M4 18h16" />
                            </svg>
                        </div>
    ...
    <div class="text-center mt-8">
        <p class="text-slate-500 dark:text-slate-400 text-sm">
            Belum memiliki alat Inkubator? <br class="md:hidden">
            <a href="/kontak" class="text-blue-600 dark:text-blue-400 font-medium hover:underline">Hubungi kami untuk pemesanan</a>
        </p>
    </div>
</div>
@endsection
